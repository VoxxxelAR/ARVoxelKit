//
//  VKSceneManager+ARSessionDelegate.swift
//  ARVoxelKit
//
...
extension VKSceneManager: ARSessionDelegate {
    ...
    public func sessionInterruptionEnded(_ session: ARSession) {
        ...
        let shouldReset = delegate?.vkSceneManager(self, shouldResetSessionFor: state) ?? true
        if shouldReset {
            resetSession()
        }
    }
